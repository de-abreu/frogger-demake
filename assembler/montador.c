...
// 1) Definir os separadores da Instrucao e quantas linhas do EXE (mif) ela
// necessita:
/*  case LOAD_CODE :
    case STORE_CODE :
    case LOADIMED_CODE :
...
// 2) Explicar como o Montador vai montar os BITs da Instrucao e escrever no
// arquivo:
...
// 3) Buscar o nome da instrucao na base de instrucoes e retornar 'op_code
// interno' da instrucao:
    ...
    while (Look != EOF) {
        ...
        if (op_code == LABEL_CODE) {
            ...
            Observacoes : alloc aloca, em tempo de montagem, um espaco
               ...
               Observacoes : alloc deve receber apenas numeros positivos
            (unsigned)
            */
            str_tmp1 = parser_GetItem_s();
            ...
            if (alloc_cnt == END_STATIC_DATA_END + 1)
                parser_Warning(
                    "Alloc ultrapassou o espaco de dados estaticos.");
        } else {
    ...
    while (Look != EOF) {
        ...
        Storei Rx, Ry
            ...
            case SOUND_CODE:
                ...
                sprintf(str_msg, "%s%s%s%s0", SOUND, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case ADD_CODE:                     // Add R1, R2, R3
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", ADD, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case ADDC_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s1", ADD, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case SUB_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", SUB, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case SUBC_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s1", SUB, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case MUL_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", MUL, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case DIV_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", DIV, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
                ...
                /* ==============
                   Inc Rx
                   Observacoes: Inc nao funcionara corretamente para nos.
                   complemento de 2.
                   ==============
                */
            ...
            case INC_CODE:
                ...
                /* ==============
                   Dec Rx
                   Observacoes: Dec nao funcionara corretamente para nos.
                   complemento de 2.
                   ==============
                */
            ...
            case AND_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", LAND, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
        ...
        Mod Rx, Ry, Rz
            ...
            case LMOD_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", LMOD, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case OR_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", LOR, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            case XOR_CODE:
                ...
                str_tmp2 = ConverteRegistrador(val2);
                str_tmp3 = ConverteRegistrador(val3);
                sprintf(str_msg, "%s%s%s%s0", LXOR, str_tmp1, str_tmp2,
                        str_tmp3);
                free(str_tmp1);
                free(str_tmp2);
                free(str_tmp3);
            ...
            /* ==============
               Var #Nr
               Observacoes : Var so deve receber numeros positivos (nao utilize
               Labels!)
               ==============
            */
            case VAR_CODE:
            ...
            /* ==============
               String "..."
               Observacoes : Pseudo-instrucao que copia a string nesta regiao da
               memoria.
               ==============
            */
            case STRING_CODE:
                ...
                /* ==============
                   ...
                   Observacoes : Endereco indicado recebera o valor indicado
                   pelo numero. Atencao : A montagem do programa pode acabar
                   sobre-escrevendo este endereco com outro valor. Utilize
                   preferencialmente para regioes fora do espaco do programa.
                   ==============
                */
    ...
    if (Look == '#') {
        ...
        if (parser_IsDigit(Look)) /* Numero : #1234 (unsigned) */
        {
            ...
            return ret;
                   ...
                   Look ==
                       '+') /* Numero com complemento de 2 : #+1234 ou #-1234 */
        {
        ...
        } else if (Look == 39) /* Char : #'a' */
        {
            ...
            } else /* Char normal : #'a' */
            {
                ...
                // ret = ret & 0x3f;  /* Tira os 2 bits mais significativos que
                // e' a COR do caractere */
                parser_GetChar();
                parser_Match(39);
                return ret;
            }
...
unsigned short RecebeEndereco(void) {
    ...
    if (parser_IsDigit(
            Look)) /* ATENCAO! Labels e EQU nao podem comecar com numeros!!! */
    {
        str_tmp = parser_GetNum_s();
        ret = atoi(str_tmp);
        free(str_tmp);
