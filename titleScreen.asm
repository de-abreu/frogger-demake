...
gameScreen:
    ...
    gameLoop:
        ...
        case_Dead:
            ...
            jne gameOver
            store a1, r2
        call drawHUD ; PERF: drawHUD was designed for the initial drawing of the HUD, we would need a new function called updateHUD to adjust just the parts of it that do change.
            loadn r7, #1060
            store frog_pos, r7
            ;call fn_drawFrog
            jmp gameLoop
